...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ParseSwift.initialize(applicationId: "UtSKvtTfIg9WZABSuCg0ChXLmEpL6SbOLk97zvKw", clientKey: "y72CUO9Xvs6RuSPEZs8QACFwPc84MPoZEpwnYNfs", serverURL: URL(string: "https://parseapi.back4app.com")!)
        
        // Instantiate a test object to ensure connection
...
// Creating a test parse object to ensure I can connect to the backend
